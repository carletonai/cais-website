...
describe('Hero Component', () => {
  ...
  it('renders action buttons with correct text and links', () => {
    ...
    expect(primaryButton.closest('a')).toHaveAttribute('href', mockProps.primaryAction.to);
    expect(secondaryButton.closest('a')).toHaveAttribute('href', mockProps.secondaryAction.to);
  });
}); 